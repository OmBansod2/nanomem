...
Package 0.6.8 · engine 3.3.4 · container format 3 · arena cache format 3.
...
```python
import nanomem
print(nanomem.__version__, nanomem.ENGINE_VERSION)   # 0.6.8 3.3.4
```
...
**530 tests**, no network required, nothing skipped when a local embedder is
