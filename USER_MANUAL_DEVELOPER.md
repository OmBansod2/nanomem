...
Package 0.7.8 · engine 3.4.1 · container format 3 · arena cache format 3.
...
```python
import nanomem
print(nanomem.__version__, nanomem.ENGINE_VERSION)   # 0.7.8 3.4.1
```
...
**571 tests**, no network required, nothing skipped when a local embedder is
