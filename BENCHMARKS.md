...
```bash
pip download --no-deps --no-binary :all: nanomem==0.7.19
tar xzf nanomem-0.7.19.tar.gz && cd nanomem-0.7.19
...
Everything here is nanomem **0.7.19 / engine 3.4.6**. This line read "0.7.9 /
