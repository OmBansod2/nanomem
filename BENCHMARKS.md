...
```bash
pip download --no-deps --no-binary :all: nanomem==0.8.2
tar xzf nanomem-0.8.2.tar.gz && cd nanomem-0.8.2
...
Everything here is nanomem **0.8.2 / engine 3.4.6**. This line read "0.7.9 /
